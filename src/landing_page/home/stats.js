      ...
      <div className="container p-3">
        <div className= "row p-5">
            <div className="col-6 p-3">
                ...
                <p className='text-muted'>That's why 1.6+ crore customers trust Zerodha with 3.5+ 
                ...
                <div className="col-6">
                <img src="media/ecosystem.png" alt="ecosystem pic" style={{width:"90%"}}/>
                <div className='text-center'>
                    ...
                    <a href='/kite demo'style={{textDecoration:"none"}}>Try Kite demo <i class="fa fa-long-arrow-right" aria-hidden="true"></i></a>
                </div>
                </div> 
        </div>
      </div>
